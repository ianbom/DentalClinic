        ...
        <div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:flex-row">
            <div className="group relative flex-1">
                ...
                <input
                    ...
                    placeholder="Cari nama dokter atau SIP..."
                    type="text"
                    value={searchQuery}
            ...
            <div className="relative w-full md:w-48">
                <select
                    className="w-full cursor-pointer appearance-none rounded-lg border-none bg-slate-50 py-2.5 pl-4 pr-10 text-slate-900 focus:ring-2 focus:ring-primary/50"
                    value={statusFilter}
                    onChange={(e) =>
                        setStatusFilter(
