        ...
        <section className="bg-background py-16 lg:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12 text-center lg:mb-16">
                    <span className="bg-secondary/10 text-secondary mb-4 inline-block rounded-full px-4 py-2 text-sm font-medium">
                        Layanan Kami
                    </span>
                    ...
                    <p className="text-text-secondary mx-auto max-w-2xl">
                        Kami menyediakan berbagai layanan perawatan gigi dengan
                        teknologi modern dan dokter berpengalaman.
                    </p>
                </div>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                    {services.map((service) => (
                        <Card key={service.title} interactive className="group">
                            <div
                                className={`h-16 w-16 ${service.color} mb-4 flex items-center justify-center rounded-2xl transition-transform group-hover:scale-110`}
                            >
                                {service.icon}
                            </div>
